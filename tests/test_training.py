...
SAMPLE_DATA = {
    "transaction_amount": [100.0, 200.0, 50.0, 300.0, 75.0, 400.0, 60.0, 250.0, 90.0, 180.0,
                           110.0, 330.0, 55.0, 210.0, 80.0],
    "transaction_hour": [10, 14, 2, 20, 8, 22, 11, 15, 3, 18, 9, 21, 4, 16, 7],
    "customer_age": [35, 42, 28, 55, 30, 60, 25, 40, 33, 50, 38, 45, 27, 52, 31],
    "account_tenure_days": [365, 720, 90, 1200, 200, 900, 60, 500, 150, 800, 400, 1000, 75, 650, 250],
    "merchant_risk_score": [0.1, 0.5, 0.8, 0.3, 0.2, 0.7, 0.4, 0.6, 0.9, 0.15, 0.25, 0.65, 0.85, 0.35, 0.12],
    "geo_distance_km": [10.0, 500.0, 2.5, 1200.0, 45.0, 800.0, 5.0, 300.0, 1.5, 600.0,
                        20.0, 700.0, 3.0, 400.0, 50.0],
    "is_international": [False, True, False, True, False, True, False, True, False, True,
                         False, True, False, True, False],
    "is_fraud": [False, False, True, True, False, True, False, False, True, False,
